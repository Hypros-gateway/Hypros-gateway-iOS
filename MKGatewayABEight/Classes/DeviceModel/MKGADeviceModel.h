...
typedef NS_ENUM(NSInteger, MKGADeviceModelState) {
    MKGADeviceModelStateOffline,
    MKGADeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKGADeviceModelOfflineNotification;

@protocol MKGADeviceModelDelegate <NSObject>
...
@interface MKGADeviceModel : NSObject
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKGADeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKGADeviceModelDelegate>delegate;
