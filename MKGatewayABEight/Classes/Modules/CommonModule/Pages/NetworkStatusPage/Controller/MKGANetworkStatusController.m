...
@interface MKGANetworkStatusController ()
...
@implementation MKGANetworkStatusController

- (void)dealloc {
    NSLog(@"MKGANetworkStatusController销毁");
}
...
- (void)confirmButtonPressed {
    ...
    [self.protocol ga_configNetworkStatusReportingInterval:[self.textField.text integerValue]
...
- (void)readDataFromServer {
    ...
    [self.protocol ga_readNetworkStatusReportingIntervalWithDeviceID:[MKGADeviceModeManager shared].deviceID
                                                          macAddress:[MKGADeviceModeManager shared].macAddress
                                                               topic:[MKGADeviceModeManager shared].subscribedTopic
                                                            sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
