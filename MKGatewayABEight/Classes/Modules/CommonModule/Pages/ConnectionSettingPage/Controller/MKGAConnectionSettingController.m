//
//  MKGAConnectionSettingController.m
...
@interface MKGAConnectionSettingController ()
...
@implementation MKGAConnectionSettingController

- (void)dealloc {
    NSLog(@"MKGAConnectionSettingController销毁");
}
...
- (void)confirmButtonPressed {
    ...
    [self.protocol ga_configConnectionTimeout:[self.textField.text integerValue]
...
- (void)readDataFromServer {
    ...
    [self.protocol ga_readConnectionTimeoutWithDeviceID:[MKGADeviceModeManager shared].deviceID
                                             macAddress:[MKGADeviceModeManager shared].macAddress
                                                  topic:[MKGADeviceModeManager shared].subscribedTopic
                                               sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
