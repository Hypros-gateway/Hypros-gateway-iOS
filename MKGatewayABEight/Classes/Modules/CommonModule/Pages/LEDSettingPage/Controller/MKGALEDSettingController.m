...
@interface MKGALedSettingModel : NSObject
...
@implementation MKGALedSettingModel
@end

@interface MKGALEDSettingController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGALedSettingModel *settingModel;

@end

@implementation MKGALEDSettingController

- (void)dealloc {
    NSLog(@"MKGALEDSettingController销毁");
}
...
- (void)confirmButtonPressed {
    ...
    [self.protocol ga_configIndicatorLightStatus:self.settingModel.ble_advertising
...
- (void)readDataFromServer {
    ...
    [self.protocol ga_readIndicatorLightStatusWithDeviceID:[MKGADeviceModeManager shared].deviceID
                                                macAddress:[MKGADeviceModeManager shared].macAddress
                                                     topic:[MKGADeviceModeManager shared].subscribedTopic
                                                  sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
...
- (MKGALedSettingModel *)settingModel {
    if (!_settingModel) {
        _settingModel = [[MKGALedSettingModel alloc] init];
    }
