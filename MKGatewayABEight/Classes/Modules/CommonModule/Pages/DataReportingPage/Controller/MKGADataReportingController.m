...
@interface MKGADataReportingController ()
...
@implementation MKGADataReportingController

- (void)dealloc {
    NSLog(@"MKGADataReportingController销毁");
}
...
- (void)confirmButtonPressed {
    ...
    [self.protocol ga_configDataReportingTimeout:([self.textField.text integerValue] * 50)
...
- (void)readDataFromServer {
    ...
    [self.protocol ga_readDataReportingTimeoutWithDeviceID:[MKGADeviceModeManager shared].deviceID
                                                macAddress:[MKGADeviceModeManager shared].macAddress
                                                     topic:[MKGADeviceModeManager shared].subscribedTopic
                                                  sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
