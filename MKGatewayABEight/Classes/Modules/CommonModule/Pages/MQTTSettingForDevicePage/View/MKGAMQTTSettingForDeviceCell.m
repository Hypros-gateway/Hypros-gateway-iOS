//
//  MKGAMQTTSettingForDeviceCell.m
...
@implementation MKGAMQTTSettingForDeviceCellModel
...
@interface MKGAMQTTSettingForDeviceCell ()
...
@implementation MKGAMQTTSettingForDeviceCell

+ (MKGAMQTTSettingForDeviceCell *)initCellWithTableView:(UITableView *)tableView {
    MKGAMQTTSettingForDeviceCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGAMQTTSettingForDeviceCellIdenty"];
    if (!cell) {
        cell = [[MKGAMQTTSettingForDeviceCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGAMQTTSettingForDeviceCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKGAMQTTSettingForDeviceCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGAMQTTSettingForDeviceCellModel.class]) {
        return;
    }
