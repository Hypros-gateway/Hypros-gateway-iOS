//
//  MKGAScanTimeoutOptionController.m
...
@interface MKGAScanTimeoutOptionController ()
...
@implementation MKGAScanTimeoutOptionController

- (void)dealloc {
    NSLog(@"MKGAScanTimeoutOptionController销毁");
}
...
- (void)confirmButtonPressed {
    ...
    [self.protocol ga_configScanTimeoutOption:[self.textField.text integerValue]
...
- (void)readDataFromServer {
    ...
    [self.protocol ga_readScanTimeoutOptionWithDeviceID:[MKGADeviceModeManager shared].deviceID
                                             macAddress:[MKGADeviceModeManager shared].macAddress
                                                  topic:[MKGADeviceModeManager shared].subscribedTopic
                                               sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
