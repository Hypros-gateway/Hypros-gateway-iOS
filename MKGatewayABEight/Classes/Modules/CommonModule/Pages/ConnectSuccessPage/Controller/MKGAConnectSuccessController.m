//
//  MKGAConnectSuccessController.m
...
@interface MKGAConnectSuccessController ()
...
@implementation MKGAConnectSuccessController

- (void)dealloc {
    NSLog(@"MKGAConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKGADeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        deviceModel.onLineState = MKGADeviceModelStateOnline;
