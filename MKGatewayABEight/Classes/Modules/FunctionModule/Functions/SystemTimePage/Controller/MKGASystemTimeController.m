...
@interface MKGASystemTimeController ()<UITableViewDelegate,
UITableViewDataSource,
MKGASystemTimeCellDelegate,
...
@implementation MKGASystemTimeController

- (void)dealloc {
    NSLog(@"MKGASystemTimeController销毁");
    if (self.readTimer) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0)  {
        //Sync Time From NTP
        MKGANTPServerController *vc = [[MKGANTPServerController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        MKGASystemTimeCell *cell = [MKGASystemTimeCell initCellWithTableView:tableView];
...
#pragma mark - MKGASystemTimeCellDelegate
...
- (void)readDataFromServer {
    ...
    [MKGAMQTTInterface ga_readDeviceUTCWithDeviceID:[MKGADeviceModeManager shared].deviceID
...
- (void)syncTimeZoneToDevice:(NSInteger)timeZone {
    ...
    [MKGAMQTTInterface ga_configDeviceTimeZone:timeZone - 24
...
- (void)loadSection1Datas {
    MKGASystemTimeCellModel *cellModel = [[MKGASystemTimeCellModel alloc] init];
    cellModel.index = 0;
