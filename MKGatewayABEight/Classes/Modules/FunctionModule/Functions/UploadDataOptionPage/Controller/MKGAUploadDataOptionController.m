//
//  MKGAUploadDataOptionController.m
...
@interface MKGAUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGAUploadDataOptionModel *dataModel;

@end

@implementation MKGAUploadDataOptionController

- (void)dealloc {
    NSLog(@"MKGAUploadDataOptionController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayABEight", @"MKGAUploadDataOptionController", @"ga_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGAUploadDataOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGAUploadDataOptionModel alloc] init];
    }
    return _dataModel;
}
