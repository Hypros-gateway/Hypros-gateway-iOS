...
@interface MKGAServerForDeviceModel ()
...
@implementation MKGAServerForDeviceModel

- (instancetype)init {
    if (self = [super init]) {
        _host = [MKGAMQTTManager shared].currentServerParams.host;
        _port = [MKGAMQTTManager shared].currentServerParams.port;
...
- (void)readPramsFromDeviceWithSucBlock:(void (^)(void))sucBlock
    ...
    dispatch_async(self.configQueue, ^{
        ...
        if (![self readNTPServerHost]) {
            [self operationFailedBlockWithMsg:@"Read NTP Server Host Error" block:failedBlock];
            return;
        }
...
- (BOOL)configHost {
    ...
    [MKGAInterface ga_configServerHost:self.host sucBlock:^{
        success = YES;
...
- (BOOL)configPort {
    __block BOOL success = NO;
    [MKGAInterface ga_configServerPort:[self.port integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientID {
    __block BOOL success = NO;
    [MKGAInterface ga_configClientID:self.clientID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configSubscribe {
    ...
    [MKGAInterface ga_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKGAInterface ga_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)configCleanSession {
    __block BOOL success = NO;
    [MKGAInterface ga_configServerCleanSession:self.cleanSession sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configQos {
    __block BOOL success = NO;
    [MKGAInterface ga_configServerQos:self.qos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configKeepAlive {
    __block BOOL success = NO;
    [MKGAInterface ga_configServerKeepAlive:[self.keepAlive integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configUserName {
    __block BOOL success = NO;
    [MKGAInterface ga_configServerUserName:self.userName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configPassword {
    __block BOOL success = NO;
    [MKGAInterface ga_configServerPassword:self.password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configSSLStatus {
    __block BOOL success = NO;
    mk_ga_connectMode mode = mk_ga_connectMode_TCP;
    if (self.sslIsOn) {
        if (self.certificate == 0) {
            mode = mk_ga_connectMode_CASignedServerCertificate;
        }else if (self.certificate == 1) {
            mode = mk_ga_connectMode_CACertificate;
        }else if (self.certificate == 2) {
            mode = mk_ga_connectMode_SelfSignedCertificates;
        }
    }
    [MKGAInterface ga_configConnectMode:mode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKGAInterface ga_configCAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKGAInterface ga_configClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKGAInterface ga_configClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configDeviceID {
    __block BOOL success = NO;
    [MKGAInterface ga_configDeviceID:self.deviceID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configNTPHost {
    __block BOOL success = NO;
    [MKGAInterface ga_configNTPServerHost:self.ntpHost sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configWifiSSID:(NSString *)ssid {
    __block BOOL success = NO;
    [MKGAInterface ga_configWIFISSID:ssid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configWifiPassword:(NSString *)password {
    __block BOOL success = NO;
    [MKGAInterface ga_configWIFIPassword:password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)exitConfigMode {
    __block BOOL success = NO;
    [MKGAInterface ga_exitConfigModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDeviceMac {
    __block BOOL success = NO;
    [MKGAInterface ga_readDeviceMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceName {
    __block BOOL success = NO;
    [MKGAInterface ga_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readConnectMode {
    __block BOOL success = NO;
    [MKGAInterface ga_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readClientID {
    __block BOOL success = NO;
    [MKGAInterface ga_readClientIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceID {
    __block BOOL success = NO;
    [MKGAInterface ga_readDeviceIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSubTopic {
    __block BOOL success = NO;
    [MKGAInterface ga_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readPubTopic {
    __block BOOL success = NO;
    [MKGAInterface ga_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readNTPServerHost {
    __block BOOL success = NO;
    [MKGAInterface ga_readNTPServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readServerUsername {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readServerPassword {
    __block BOOL success = NO;
    [MKGAInterface ga_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
