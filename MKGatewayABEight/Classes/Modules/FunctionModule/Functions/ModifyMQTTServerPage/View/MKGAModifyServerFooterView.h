...
@interface MKGAModifyServerFooterViewModel : NSObject
...
@protocol MKGAModifyServerFooterViewDelegate <NSObject>
...
@interface MKGAModifyServerFooterView : UIView

@property (nonatomic, strong)MKGAModifyServerFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKGAModifyServerFooterViewDelegate>delegate;
