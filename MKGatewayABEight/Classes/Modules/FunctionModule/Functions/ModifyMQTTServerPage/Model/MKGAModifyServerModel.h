...
@class MKGAModifyServerModel;
@interface MKGAUpdateMQTTServerModel : NSObject<ga_updateMQTTServerProtocol>
...
@interface MKGAModifyServerModel : NSObject
