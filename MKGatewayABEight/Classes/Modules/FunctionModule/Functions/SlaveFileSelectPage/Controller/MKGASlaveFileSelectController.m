//
//  MKGASlaveFileSelectController.m
...
@interface MKGASlaveFileSelectController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKGASlaveFileSelectController

- (void)dealloc {
    NSLog(@"MKGASlaveFileSelectController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(ga_slaveFileSelected:)]) {
        [self.delegate ga_slaveFileSelected:fileModel.leftMsg];
    }
