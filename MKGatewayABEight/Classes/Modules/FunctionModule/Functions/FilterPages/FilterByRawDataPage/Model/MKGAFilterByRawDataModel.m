...
@interface MKGAFilterByRawDataModel ()
...
@implementation MKGAFilterByRawDataModel
...
- (BOOL)readFilterByRawData {
    ...
    [MKGAMQTTInterface ga_readFilterByRawDataStatusWithDeviceID:[MKGADeviceModeManager shared].deviceID macAddress:[MKGADeviceModeManager shared].macAddress topic:[MKGADeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
