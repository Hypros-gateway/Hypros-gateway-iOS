...
extern NSString *const MKGAMMQTTSessionManagerStateChangedNotification;

//Notification of device online.
extern NSString *const MKGAMReceiveDeviceNetStateNotification;

NS_ASSUME_NONNULL_BEGIN

@interface MKGAMMQTTManager : NSObject<MKGAServerManagerProtocol>
