...
@interface MKGAAboutController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKGAAboutController

- (void)dealloc {
    NSLog(@"MKGAAboutController销毁");
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKGAAboutCellModel *model = self.dataList[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKGAAboutCell *cell = [MKGAAboutCell initCellWithTableView:tableView];
...
- (void)loadTableDatas {
    MKGAAboutCellModel *faxModel = [[MKGAAboutCellModel alloc] init];
    faxModel.iconName = @"ga_faxIcon.png";
    faxModel.typeMessage = @"Fax";
    faxModel.value = @"86-75523573370-808";
    [self.dataList addObject:faxModel];
    
    MKGAAboutCellModel *telModel = [[MKGAAboutCellModel alloc] init];
    telModel.iconName = @"ga_telIcon.png";
    telModel.typeMessage = @"Tel";
    telModel.value = @"86-75523573370";
    [self.dataList addObject:telModel];
    
    MKGAAboutCellModel *addModel = [[MKGAAboutCellModel alloc] init];
    addModel.iconName = @"ga_addUsIcon.png";
    ...
    MKGAAboutCellModel *linkModel = [[MKGAAboutCellModel alloc] init];
    linkModel.iconName = @"ga_shouceIcon.png";
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKGatewayABEight", @"MKGAAboutController", @"ga_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIView *)tableFooter {
    UIView *footer = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kViewWidth, 250.f)];
...
//    feedButton.frame = CGRectMake(40.f, 130.f, kViewWidth - 2 * 40.f, 40.f);
//    [footer addSubview:feedButton];
    
    self.companyNameLabel.frame = CGRectMake(0, 85.f, kViewWidth, MKFont(17).lineHeight);
