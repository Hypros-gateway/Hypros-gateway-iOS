...
@implementation MKGAEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKGatewayABEight", @"MKGAEasyShowView", @"ga_refreshIcon.png");
    }
    return _refreshIcon;
}
