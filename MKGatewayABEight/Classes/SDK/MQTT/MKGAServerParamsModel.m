...
static NSString *const fileName = @"MKGAServerParams.txt";

@interface MKGAServerParamsModel ()
...
@implementation MKGAServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKGAServerParamsProtocol>)protocol {
